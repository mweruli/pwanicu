						...
						<ul class="row">
							<li class="col-md-12">
								<div class="church-blog-large-wrap">
									<figure><a href="blog-detail.html"><img src="extra-images/pu/prayer.JPG" alt=""><i class="fab fa-algolia"></i></a>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="church-team-detail">
						<div class="row">
							<div class="col-md-6">
								<h2 class="church-section-heading"> Prayer Department Members </h2>
