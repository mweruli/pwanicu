                        ...
                        <ul class="row">
                            <li class="col-md-12">
                                <div class="church-cause-list-wrap">
                                    <figure><a href="alumni.php"><img src="extra-images/pu/behn-mwalimu.JPG" alt=""><span>EVANS KARANI</span></a></figure>
                                    <div class="church-cause-list-text">
                                        <h2><a href="error.php">EVANS KARANI</a></h2>
