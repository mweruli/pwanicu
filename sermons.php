...
<label><input type="submit" value=""></label>
					...
					<div class="widget widget_popular_news">
						...
						<ul>
							<li>
								<figure><a href="sermons.php"><img src="extra-images/popular-post-img1.jpg" alt=""></a></figure>
								<div class="widget-popular-news-text">
									<h6><a href="sermons.php">Sed vulputate elem ntum aliquam.</a></h6>
									<time datetime="2008-02-14 20:00"><i class="far fa-calendar-alt"></i> 21 Aug 2017</time>
								</div>
							</li>
							<li>
								<figure><a href="blog.php"><img src="extra-images/popular-post-img2.jpg" alt=""></a></figure>
								<div class="widget-popular-news-text">
									<h6><a href="blog.php">Sed vulputate elem ntum aliquam.</a></h6>
									<time datetime="2008-02-14 20:00"><i class="far fa-calendar-alt"></i> 21 Aug 2017</time>
								</div>
							</li>
							<li>
								<figure><a href="blog.php"><img src="extra-images/popular-post-img3.jpg" alt=""></a></figure>
								<div class="widget-popular-news-text">
									<h6><a href="blog.php">Sed vulputate elem ntum aliquam.</a></h6>
									<time datetime="2008-02-14 20:00"><i class="far fa-calendar-alt"></i> 21 Aug 2017</time>
								</div>
							...
							<li>
								<figure><a href="blog.php"><img src="extra-images/popular-post-img4.jpg" alt=""></a></figure>
								<div class="widget-popular-news-text">
									<h6><a href="blog.php">Sed vulputate elem ntum aliquam.</a></h6>
									<time datetime="2008-02-14 20:00"><i class="far fa-calendar-alt"></i></i> 21 Aug 2017</time>
								</div>
							</li>
						</ul>
					</div>
					...
					<div class="widget widget_upcoming_event">
						...
						<ul>
							<li>
								...
								<section>
									<h6><a href="blog.php">Ut gravida nulla iad ornare sodales</a></h6>
									<a href="blog.php">By Mark Jordan</a>
								</section>
							</li>
							<li>
								<time datetime="2008-02-14 20:00"> 13 <span>Sep</span></time>
								<section>
									<h6><a href="blog.php">Cras in sapien ultri ces, molestie</a></h6>
									<a href="blog.php">By Mark Jordan</a>
								</section>
							</li>
							<li>
								...
								<section>
									<h6><a href="blog.php">Aenean ultricis tell us eget sem</a></h6>
									<a href="blog.php">By Mark Jordan</a>
								</section>
							</li>
							<li>
								...
								<section>
									<h6><a href="blog.php">Vivamus malesu as ada nunc nibh</a></h6>
									<a href="blog.php">By Mark Jordan</a>
								</section>
							</li>
						</ul>
					...
					<div class="widget widget_gallery">
						<h2 class="church-widget-heading">[ Sermons Photos ]</h2>
						<ul>
							<li>
				...
				<div class="col-md-9">
					<div class="church-sermon church-sermon-grid">
						<ul class="row">
							<li class="col-md-6">
								<figure><a href="sermons.php"><img src="extra-images/sermon-grid-img1.jpg" alt=""><span>Read More...</span></a></figure>
								<div class="church-sermon-grid-text">
									<h2><a href="sermons.php">Nunc Pulvinar Massa Nunc Quis Pel</a></h2>
									<ul class="church-cause-option">
										...
										<li><i class="fas fa-clipboard"></i><a href="error.php">Education,</a><a href="sermons.php">Learning,</a><a href="error.php">School,</a><a href="sermons.php">Water</a></li>
									</ul>
									<p>Sed vulputate elementum aliquam. Nunc vel efficitur ante. Ut gravida ndales. </p>
									<ul class="church-sermon-social">
										<li><a href="error.php" class="fas fa-play" data-toggle="tooltip" title="Play"></a></li>
										<li><a href="error.php" class="fas fa-download" data-toggle="tooltip" title="Download"></a></li>
										<li><a href="error.php" class="fas fa-thumbs-up" data-toggle="tooltip" title="Like"></a></li>
										<li><a href="error.php" class="fas fa-share-alt-square" data-toggle="tooltip" title="Share"></a></li>
									</ul>
								</div>
							</li>
							<li class="col-md-6">
								<figure><a href="sermons.php"><img src="extra-images/sermon-grid-img2.jpg" alt=""><span>Read More...</span></a></figure>
								<div class="church-sermon-grid-text">
							...
							<li class="col-md-6">
								<figure><a href="sermons.php"><img src="extra-images/sermon-grid-img3.jpg" alt=""><span>Read More...</span></a></figure>
								<div class="church-sermon-grid-text">
							...
							<li class="col-md-6">
								<figure><a href="sermons.php"><img src="extra-images/sermon-grid-img4.jpg" alt=""><span>Read More...</span></a></figure>
								<div class="church-sermon-grid-text">
									<h2><a href="sermons.php">Curabitur Sit Amet Sapien ut Metus</a></h2>
									<ul class="church-cause-option">
										<li><i class="icon church-user-silhouette"></i><a href="sermons.php">Elena Jameson</a></li>
							...
							<li class="col-md-6">
								<figure><a href="sermons.php"><img src="extra-images/sermon-grid-img5.jpg" alt=""><span>Read More...</span></a></figure>
								<div class="church-sermon-grid-text">
							...
							<li class="col-md-6">
								<figure><a href="sermons.php"><img src="extra-images/sermon-grid-img6.jpg" alt=""><span>Read More...</span></a></figure>
								<div class="church-sermon-grid-text">
					...
					<div class="church-pagination">
						<ul class="page-numbers">
							<li><a class="previous page-numbers" href="sermons.php"><span aria-label="Next"><i class="fa fa-angle-left"></i></span></a></li>
							<li><span class="page-numbers current">01</span></li>
							<li><a class="page-numbers" href="sermons.php">02</a></li>
							<li><a class="page-numbers" href="sermons.php">03</a></li>
							<li><a class="page-numbers" href="sermons.php">04</a></li>
							<li><a class="next page-numbers" href="sermons.php"><span aria-label="Next"><i class="fa fa-angle-right"></i></span></a></li>
						</ul>
					</div>
